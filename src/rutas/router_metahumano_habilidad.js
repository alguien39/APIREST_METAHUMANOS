...
import {validarCrearMetahumanoHabilidad} from "../validators/metahumano_habilidad.validator.js";
...
router.post('/', validarCrearMetahumanoHabilidad, validarCampos, Controlador.createMetahumano_Habilidad);
